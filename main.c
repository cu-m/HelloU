...
OSScreenPutFontEx(SCREEN_TV, 0, 0, "Rashed is the best");
OSScreenPutFontEx(SCREEN_TV, 0, 1, "Hello!");

OSScreenPutFontEx(SCREEN_DRC, 0, 0, "Rashed is the best");
OSScreenPutFontEx(SCREEN_DRC, 0, 1, "Hello!");
